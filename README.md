...
A minimal Ruby on Rails app for storing **notes** and **secrets/credentials** locally. Each user has a private vault and entry titles and bodies are **encrypted at rest** in SQLite.
