...
A minimal Ruby on Rails app for storing **notes** and **secrets/credentials** locally. Each user has a private vault and entries are **encrypted at rest** inside an SQLite database.
